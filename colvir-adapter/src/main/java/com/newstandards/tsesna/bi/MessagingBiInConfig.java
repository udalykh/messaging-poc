 ...
 * automatically if "messaging-in" Spring profile is active.
 */
@Configuration
@Profile("messaging-in")
@ImportResource("classpath:com/newstandards/tsesna/bi/messaging-bi-config-in.xml")
